...
namespace RCD_Project.Views.EmployeCollectionView{
    public partial class EmployeCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<RCD_Project.ViewModels.EmployeCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as RCD_Project.Employe,
