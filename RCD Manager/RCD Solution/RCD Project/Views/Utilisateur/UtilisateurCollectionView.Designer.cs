namespace RCD_Project.Views.UtilisateurCollectionView {
    partial class UtilisateurCollectionView {
		...
		private void InitializeComponent() {
			...
			this.utilisateurCollectionViewBindingSource.DataSource = typeof(RCD_Project.Utilisateur);
			...
			this.gridView.PopulateColumns(typeof(RCD_Project.Utilisateur),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(RCD_Project.ViewModels.UtilisateurCollectionViewModel);
			// 
            // layoutControl
            // 
