namespace Car_Express_Solution.Views.reservationCollectionView {
    partial class reservationCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "reservation";
			// 
            // gridControl
            // 
			...
			this.reservationCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.reservationCollectionViewBindingSource.DataSource = typeof(Car_Express_Solution.reservation);
			this.gridControl.DataSource = reservationCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(Car_Express_Solution.reservation),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Car_Express_Solution.ViewModels.reservationCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "reservationCollectionView";
		...
		private System.Windows.Forms.BindingSource reservationCollectionViewBindingSource;
