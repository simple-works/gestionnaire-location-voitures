namespace Car_Express_Solution.Views.contratView {
    partial class contratView {
		...
		private void InitializeComponent() {
			...
			this.contratViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.contratViewBindingSource.DataSource = typeof(Car_Express_Solution.contrat);
			this.dataLayoutControl1.DataSource = contratViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.clientLookUpEdit.DataBindings.Add("EditValue", contratViewBindingSource, "id_client_fk", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.client1LookUpEdit.DataBindings.Add("EditValue", contratViewBindingSource, "id_client_compagnon_fk", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.employeLookUpEdit.DataBindings.Add("EditValue", contratViewBindingSource, "id_employe_conducteur_fk", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.vehiculeLookUpEdit.DataBindings.Add("EditValue", contratViewBindingSource, "immatriculation_vehicule_fk", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Car_Express_Solution.ViewModels.contratViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "contrat - Element View";
		...
		private System.Windows.Forms.BindingSource contratViewBindingSource;
