namespace Car_Express_Solution.Views.employeCollectionView {
    partial class employeCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "employe";
			// 
            // gridControl
            // 
			...
			this.employeCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.employeCollectionViewBindingSource.DataSource = typeof(Car_Express_Solution.employe);
			this.gridControl.DataSource = employeCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters contratsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            contratsPopulateColumnParameters_NotVisible.FieldName = "contrats";
		    contratsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(contratsPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters reservationsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            reservationsPopulateColumnParameters_NotVisible.FieldName = "reservations";
		    reservationsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(reservationsPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters utilisateursPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            utilisateursPopulateColumnParameters_NotVisible.FieldName = "utilisateurs";
		    utilisateursPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(utilisateursPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(Car_Express_Solution.employe),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Car_Express_Solution.ViewModels.employeCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "employeCollectionView";
		...
		private System.Windows.Forms.BindingSource employeCollectionViewBindingSource;
