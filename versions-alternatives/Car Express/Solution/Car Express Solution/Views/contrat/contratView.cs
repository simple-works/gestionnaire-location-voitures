...
namespace Car_Express_Solution.Views.contratView{
    public partial class contratView : XtraUserControl {
        public contratView() {
            InitializeComponent();
		...
		void InitBindings() {
		    var fluentAPI = mvvmContext.OfType<Car_Express_Solution.ViewModels.contratViewModel>();
			fluentAPI.WithEvent(this, "Load").EventToCommand(x => x.OnLoaded());
            fluentAPI.SetObjectDataSourceBinding(
                contratViewBindingSource, x => x.Entity, x => x.Update());
