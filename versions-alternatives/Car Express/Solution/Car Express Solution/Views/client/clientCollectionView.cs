...
namespace Car_Express_Solution.Views.clientCollectionView{
    public partial class clientCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Car_Express_Solution.ViewModels.clientCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as Car_Express_Solution.client,
