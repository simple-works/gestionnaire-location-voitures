...
namespace Car_Express_Solution.ViewModels {
    ...
    /// </summary>
    public partial class clientCollectionViewModel : CollectionViewModel<client, int, ICar_Express_EntitiesUnitOfWork> {

        /// <summary>
        /// Creates a new instance of clientCollectionViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static clientCollectionViewModel Create(IUnitOfWorkFactory<ICar_Express_EntitiesUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected clientCollectionViewModel(IUnitOfWorkFactory<ICar_Express_EntitiesUnitOfWork> unitOfWorkFactory = null)
